...
Esto es lo que permitió, entre otras cosas, migrar de whatsapp-web.js a Baileys sin tocar una línea de lógica de negocio, y tener 159 tests que corren sin WhatsApp.
...
Tres suites, 159 chequeos, corren sin WhatsApp con `npm test`:
